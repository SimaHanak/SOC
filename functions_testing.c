...
double dA_z(double r, double z, Params *p) {
    ...
    double term2 = 32*pow(z, 3)*(20*(*p).J*(*p).J*(*p).M - 7*pow((*p).M, 5) - 22*(*p).M2*(*p).M*(*p).M - 7*(*p).M4);
    return term1 + term2;
}

double ddA_r_r(double r, double z, Params *p) {
    double term1 = 16*z*z*(24*(*p).J*(*p).J*(*p).M + 17*(*p).M*(*p).M*(*p).M2 + 21*(*p).M4);
    double term2 = 12*r*r*(-10*(*p).J*(*p).J*(*p).M + 7*pow((*p).M, 5) + 32*(*p).M2*(*p).M*(*p).M - 21*(*p).M4);
    return term1 + term2;
}
...
double ddA_z_z(double r, double z, Params *p) {
    ...
    double term2 = 96*z*z*(20*(*p).J*(*p).J*(*p).M - 7*pow((*p).M, 5) - 22*(*p).M2*(*p).M*(*p).M - 7*(*p).M4);
    return term1 + term2;
}
...
double dB_r(double r, double z, Params *p) {
    double term1 = 4*pow(r, 3)*(10*(*p).J*(*p).J*(*p).M*(*p).M + 10*(*p).M2*pow((*p).M, 3) + 21*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    double term2 = - 8*r*z*z*(27*(*p).J*(*p).J*(*p).M*(*p).M - 21*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 48*(*p).M2*pow((*p).M, 3) + 42*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    return term1 + term2;
}

double dB_z(double r, double z, Params *p) {
    double term1 = 16*pow(z, 3)*(-40*(*p).J*(*p).J*(*p).M*(*p).M - 14*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 30*(*p).M2*pow((*p).M, 3) + 14*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    double term2 = - 8*r*r*z*(27*(*p).J*(*p).J*(*p).M*(*p).M - 21*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 48*(*p).M2*pow((*p).M, 3) + 42*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    return term1 + term2;
}

double ddB_r_r(double r, double z, Params *p) {
    double term1 = 12*r*r*(10*(*p).J*(*p).J*(*p).M*(*p).M + 10*(*p).M2*pow((*p).M, 3) + 21*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    double term2 = - 8*z*z*(27*(*p).J*(*p).J*(*p).M*(*p).M - 21*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 48*(*p).M2*pow((*p).M, 3) + 42*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    return term1 + term2;
}

double ddB_r_z(double r, double z, Params *p) {
    return - 16*r*z*(27*(*p).J*(*p).J*(*p).M*(*p).M - 21*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 48*(*p).M2*pow((*p).M, 3) + 42*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
}

double ddB_z_z(double r, double z, Params *p) {
    double term1 = 48*z*z*(-40*(*p).J*(*p).J*(*p).M*(*p).M - 14*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 30*(*p).M2*pow((*p).M, 3) + 14*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    double term2 = - 8*r*r*(27*(*p).J*(*p).J*(*p).M*(*p).M - 21*(*p).J*(*p).S3 + 7*pow((*p).M, 6) + 48*(*p).M2*pow((*p).M, 3) + 42*(*p).M4*(*p).M + 7*(*p).M2*(*p).M2);
    return term1 + term2;
}
...
double dH_z(double r, double z, Params *p) {
    return 8*r*r*z*((*p).J*((*p).M2 - 2*pow((*p).M, 3)) - 3*(*p).M*(*p).S3);
}

double ddH_r_r(double r, double z, Params *p) {
    double term1 = 8*z*z*((*p).J*((*p).M2 - 2*pow((*p).M, 3)) - 3*(*p).M*(*p).S3);
    double term2 = 12*r*r*((*p).J*(*p).M2 + 3*(*p).M*(*p).S3);
    return term1 + term2;
}

double ddH_r_z(double r, double z, Params *p) {
    return 16*r*z*((*p).J*((*p).M2 - 2*pow((*p).M, 3)) - 3*(*p).M*(*p).S3);
}

double ddH_z_z(double r, double z, Params *p) {
    return 8*r*r*((*p).J*((*p).M2 - 2*pow((*p).M, 3)) - 3*(*p).M*(*p).S3);
}
...
double dG_z(double r, double z, Params *p) {
    double term1 = pow((*p).J, 3)*(- 4*z*z + 3*r*r);
    double term2 = (*p).J*(*p).M*(- 4*z*z*(3*pow((*p).M, 3) + 2*(*p).M2) + (pow((*p).M, 3) + 10*(*p).M2)*r*r);
...
double ddG_r_r(double r, double z, Params *p) {
    ...
    double left = r*r;
    double dright = 4*r*(pow((*p).J, 3)*(- r*r + 8*z*z)
                        + (*p).J*(*p).M*(r*r*(pow((*p).M, 3) + 2*(*p).M2) + 2*z*z*(pow((*p).M, 3) + 10*(*p).M2))
                        + 3*(*p).M*(*p).M*(*p).S3*(r*r + 2*z*z));
    double ddright = 4*(*p).J*pow((*p).M, 4)*(3*r*r + 2*z*z) + 8*(*p).J*(*p).M*(*p).M2*(3*r*r + 10*z*z) + 12*pow((*p).J, 3)*(-r*r + 2*z*z) + 12*(*p).M*(*p).M*(*p).S3*(3*r*r + 2*z*z);
    double right = term1 + term2 + term3;
    double dleft = 2*r;
    double ddleft = 2;
...
double ddG_r_z(double r, double z, Params *p) {
    ...
    double left = r*r;
    double dterm1_z = pow((*p).J, 3)*( - 32*pow(z, 3) + 24*r*r*z);
    double dterm2_z = (*p).J*(*p).M*(- 32*(3*pow((*p).M, 3) + 2*(*p).M2)*pow(z, 3) + 8*(pow((*p).M, 3) + 10*(*p).M2)*r*r*z);
    double dterm3_z = (*p).M*(*p).M*(*p).S3*(- 160*pow(z, 3) + 24*r*r*z);
    double dright_z = dterm1_z + dterm2_z + dterm3_z;
    double ddright = 8*r*z*(6*pow((*p).J, 3) + 2*(*p).J*(*p).M*(pow((*p).M, 3) + 10*(*p).M2) + 6*(*p).M*(*p).M*(*p).S3);
    double dleft_r = 2*r;
    return left*ddright + dleft_r*dright_z;
}

double ddG_z_z(double r, double z, Params *p) {
    double term1 = - 8*z*pow((*p).J, 3);
    double term2 = - 8*z*(*p).J*(*p).M*(3*pow((*p).M, 3) + 2*(*p).M2);
    double term3 = - 40*z*(*p).M*(*p).M*(*p).S3;

    double dright = term1 + term2 + term3;
    
    term1 = pow((*p).J, 3)*(- 4*z*z + 3*r*r);
    term2 = (*p).J*(*p).M*(- 4*z*z*(3*pow((*p).M, 3) + 2*(*p).M2) + (pow((*p).M, 3) + 10*(*p).M2)*r*r);
...
double f(double r, double z, Params *p) {
    ...
    double term6 = (A(r, z, p))/(28*pow(pyth, 9.0/2.0));
    double term7 = (B(r, z, p))/(14*pow(pyth, 5));
...
double df_z(double r, double z, Params *p) {
    ...
    double term6 = (pow(pyth, 9.0/2.0)*dA_z(r, z, p) - 9*z*pow(pyth, 7.0/2.0)*A(r, z, p))/(28*pow(pyth, 9));
    double term7 = (pow(pyth, 5)*dB_z(r, z, p) - 10*z*pow(pyth, 4)*B(r, z, p))/(14*pow(pyth, 10));
    return term1 + term2 + term3 + term4 + term5 + term6 + term7;
}
...
double ddf_r_r(double r, double z, Params *p) {
    ...
    double term3 = - 4*(*p).M*(*p).M*(z*z - 3*r*r)/pow(pyth, 3);
    double term4 = (12*pow(r, 4)*((*p).M2 - pow((*p).M, 3)) - 3*r*r*z*z*(27*(*p).M2 + 13*pow((*p).M, 3)) + 4*pow(z, 4)*(3*(*p).M2 + 2*pow((*p).M, 3)))/pow(pyth, 9.0/2.0);
    double term5 = 4*((*p).M*(*p).M2*(-pyth*pyth + 15*r*r*pyth - 24*pow(r, 4)) + 3*z*z*(- (*p).J*(*p).J + pow((*p).M, 4) + 2*(*p).M*(*p).M2)*(-pyth + 8*r*r))/pow(pyth, 5);
    double term6 = (ddA_r_r(r, z, p)*pyth*pyth - 18*dA_r(r, z, p)*r*pyth + 9*A(r, z, p)*(10*r*r - z*z))/(28*pow(pyth, 13.0/2.0));
    double term7 = (ddB_r_r(r, z, p)*pyth*pyth - 20*dB_r(r, z, p)*r*pyth + 10*B(r, z, p)*(11*r*r - z*z))/(14*pow(pyth, 7));
    return term1 + term2 + term3 + term4 + term5 + term6 + term7;
}
...
double ddf_z_z(double r, double z, Params *p) {
    double pyth = pythagorean(r, z, p);
    double term1 = 0;
    double term2 = 2*(*p).M*(pyth - 3*z*z)/pow(pyth, 5.0/2.0);
    double term3 = - 4*(*p).M*(*p).M*(pyth - 4*z*z)/pow(pyth, 3);
    double term4 = (2*(pow((*p).M, 3) + (*p).M2)*(-2*pyth*pyth + 25*z*z*pyth - 35*pow(z, 4)) + 5*r*r*((*p).M2 - pow((*p).M, 3))*(- pyth + 7*z*z))/pow(pyth, 9.0/2.0);
    double term5 = 4*((-15*z*z*pyth + pyth*pyth + 24*pow(z, 4))*(-(*p).J*(*p).J + pow((*p).M, 4) + 2*(*p).M2*(*p).M) + 3*r*r*(*p).M*(*p).M2*(pyth - 8*z*z))/pow(pyth, 5);
    double term6 = (ddA_z_z(r, z, p)*pyth*pyth - 18*dA_z(r, z, p)*z*pyth - 9*A(r, z, p)*(pyth - 11*z*z))/(28*pow(pyth, 13.0/2.0));
    double term7 = (ddB_z_z(r, z, p)*pyth*pyth - 20*dB_z(r, z, p)*z*pyth - 10*B(r, z, p)*(pyth - 12*z*z))/(14*pow(pyth, 7));
    return term1 + term2 + term3 + term4 + term5 + term6 + term7;
}
...
double omega(double r, double z, Params *p) {
    ...
    double term3 = + (F(r, z, p))/(pow(pyth, 7.0/2.0));
    double term4 = + (H(r, z, p))/(2*pow(pyth, 4));
    double term5 = + (G(r, z, p))/(4*pow(pyth, 11.0/2.0));
...
double domega_r(double r, double z, Params *p) {
    ...
    double term3 = + (dF_r(r, z, p)*pow(pyth, 7.0/2.0) - 7*r*pow(pyth, 5.0/2.0)*F(r, z, p))/(pow(pyth, 7));
    double term4 = + (2*dH_r(r, z, p)*pow(pyth, 4) - 16*r*pow(pyth, 3)*H(r, z, p))/(4*pow(pyth, 8));
    double term5 = + (4*dG_r(r, z, p)*pow(pyth, 11.0/2.0) - 44*r*pow(pyth, 9.0/2.0)*G(r, z, p))/(16*pow(pyth, 11));
    return term1 + term2 + term3 + term4 + term5;
}
...
double domega_z(double r, double z, Params *p) {
    ...
    double term3 = + (dF_z(r, z, p)*pow(pyth, 7.0/2.0) - 7*z*pow(pyth, 5.0/2.0)*F(r, z, p))/(pow(pyth, 7));
    double term4 = + (2*dH_z(r, z, p)*pow(pyth, 4) - 16*z*pow(pyth, 3)*H(r, z, p))/(4*pow(pyth, 8));
    double term5 = + (4*dG_z(r, z, p)*pow(pyth, 11.0/2.0) - 44*z*pow(pyth, 9.0/2.0)*G(r, z, p))/(16*pow(pyth, 11));
    return term1 + term2 + term3 + term4 + term5;
}

double ddomega_r_r(double r, double z, Params *p) {
    double pyth = pythagorean(r, z, p);
    double term1 = 2*(*p).J*(15*r*r*pyth - 15*pow(r, 4) - 2*pyth*pyth)/pow(pyth, 7.0/2.0); // CHECKED
    double term2 = 4*(*p).J*(*p).M*(10*r*r*pyth - pyth*pyth - 12*pow(r, 4))/pow(pyth, 4); // CHECKED
    double term3 = (ddF_r_r(r, z, p)*pyth*pyth - 14*dF_r(r, z, p)*r*pyth - 7*F(r, z, p)*(pyth - 9*r*r))/pow(pyth, 11.0/2.0);
    double term4 = (ddH_r_r(r, z, p)*pyth*pyth - 16*dH_r(r, z, p)*r*pyth - 8*H(r, z, p)*(pyth - 10*r*r))/(2*pow(pyth, 6));
    double term5 = (ddG_r_r(r, z, p)*pyth*pyth - 22*dG_r(r, z, p)*r*pyth + 11*G(r, z, p)*(12*r*r - z*z))/(4*pow(pyth, 15.0/2.0));
    return term1 + term2 + term3 + term4 + term5;
}

double ddomega_r_z(double r, double z, Params *p){
    double pyth = pythagorean(r, z, p);
    double term1 = 6*(*p).J*r*(2*z*pyth - 5*r*r*z)/pow(pyth, 7.0/2.0);
    double term2 = 16*(*p).J*(*p).M*r*(z*pyth - 3*r*r*z)/pow(pyth, 4);
    double term3 = (ddF_r_z(r, z, p)*pyth*pyth - 7*dF_r(r, z, p)*z*pyth - 7*dF_z(r, z, p)*r*pyth + 63*F(r, z, p)*r*z)/pow(pyth, 11.0/2.0);
    double term4 = (ddH_r_z(r, z, p)*pyth*pyth - 8*dH_r(r, z, p)*z*pyth - 8*dH_z(r, z, p)*r*pyth + 80*H(r, z, p)*r*z)/(2*pow(pyth, 6));
    double term5 = (ddG_r_z(r, z, p)*pyth*pyth - 11*dG_r(r, z, p)*z*pyth - 11*dG_z(r, z, p)*r*pyth + 143*G(r, z, p)*r*z)/(4*pow(pyth, 15.0/2.0));
    return term1 + term2 + term3 + term4 + term5;
}

double ddomega_z_z(double r, double z, Params *p){
    double pyth = pythagorean(r, z, p);
    double term1 = 6*r*r*(*p).J*(pyth - 5*z*z)/pow(pyth, 7.0/2.0);
    double term2 = 8*r*r*(*p).J*(*p).M*(pyth - 6*z*z)/pow(pyth, 4);
    double term3 = (ddF_z_z(r, z, p)*pyth*pyth - 14*dF_z(r, z, p)*z*pyth - 7*F(r, z, p)*(pyth - 9*z*z))/pow(pyth, 11.0/2.0);
    double term4 = (ddH_z_z(r, z, p)*pyth*pyth - 16*dH_z(r, z, p)*z*pyth - 8*H(r, z, p)*(pyth - 10*z*z))/(2*pow(pyth, 6));
    double term5 = (ddG_z_z(r, z, p)*pyth*pyth - 22*dG_z(r, z, p)*z*pyth + 11*G(r, z, p)*(12*z*z - r*r))/(4*pow(pyth, 15.0/2.0));
    return term1 + term2 + term3 + term4 + term5;
}
...
double dgamma_r(double r, double z, Params *p) {
    ...
    double term2 = - (r*pyth*(*p).M*(*p).M - 2*pow(r, 3)*(*p).M*(*p).M)/(pow(pyth, 3));
    return term1 + term2;
}
...
double dgamma_z(double r, double z, Params *p) {
    ...
    double term2 = + (2*r*r*z)/pow(pyth, 3);
    return term1 + term2;
}
...
double ddgamma_r_r(double r, double z, Params *p) {
    double pyth = pythagorean(r, z, p);
    double right = (*p).J*(*p).J*(r*r - 8*z*z) + (*p).M*(pow((*p).M, 3) + 3*(*p).M2)*(r*r - 4*z*z);
    double term1 = (r*r*pyth*((*p).J*(*p).J + (*p).M*(pow((*p).M, 3) + 3*(*p).M2))*(5*z*z - 11*r*r) + right*(pyth*(z*z - 19*r*r) + 40*pow(r, 4)))/(2*pow(pyth, 6));
    double term2 = (*p).M*(*p).M*(- 8*z*z*r*r + 3*pow(r, 4) + pow(z, 4))/pow(pyth, 4);
    return term1 - term2;
...
double ddgamma_r_z(double r, double z, Params *p) {
    double pyth = pythagorean(r, z, p);
    double right = (*p).J*(*p).J*(r*r - 8*z*z) + (*p).M*(pow((*p).M, 3) + 3*(*p).M2)*(r*r - 4*z*z);
    double A = (*p).J*(*p).J + (*p).M*(pow((*p).M, 3) + 3*(*p).M2);
    double B = 2*(*p).J*(*p).J + (*p).M*(pow((*p).M, 3) + 3*(*p).M2);
    double term1 = 4*r*z*(pow(r, 4)*(3*B - A) + z*z*r*r*(2*B - A) - pow(z, 4)*B + right*(4*r*r - z*z))/pow(pyth, 6);
...
double ddgamma_z_z(double r, double z, Params *p) {
    double pyth = pythagorean(r, z, p);
    double A = (*p).J*(*p).J;
    double B = (*p).M*(pow((*p).M, 3) + 3*(*p).M2);
    double term1 = - 2*r*r*(pow(r, 4)*(3*A + 2*B) - 9*r*r*z*z*(5*A + 3*B) + 7*pow(z, 4)*(6*A + 3*B))/pow(pyth, 6);
    double term2 = 2*r*r;
    term2 *= r*r - 5*z*z;
    term2 /= pow(pyth, 4);
    return term1 + term2;
...
double ddg_ff_r_r(double r, double z, Params *p) {
    ...
    double term1 = -2*(df_r_val*omega_val*domega_r_val + f_val*pow(domega_r_val, 2) + f_val*omega_val*ddomega_r_r(r, z, p));
    double term2 = -ddf_r_r_val*pow(omega_val, 2) - 2*df_r_val*omega_val*domega_r_val; 
    double term3 = (dnum_r*pow(f_val, 2) - 2*num*f_val*df_r_val)/pow(f_val, 4);
    return term1 + term2 + term3;
}
double ddg_ff_r_z(double r, double z, Params *p) {
    ...
    double term2 = -ddf_r_z(r, z, p)*pow(omega_val, 2) - 2*df_r(r, z, p)*omega_val*domega_z_val;
    double term3 = (dnum_z*pow(f_val, 2) - 2*num*f_val*df_z_val)/pow(f_val, 4);
    return term1 + term2 + term3;
}
double ddg_ff_z_z(double r, double z, Params *p) {
    ...
    double term1 = -2*(df_z_val*omega_val*domega_z_val + f_val*pow(domega_z_val, 2) + f_val*omega_val*ddomega_z_z(r, z, p));
    double term2 = -ddf_z_z_val*pow(omega_val, 2) - 2*df_z_val*omega_val*domega_z_val;
    double term3 = (dnum_z*pow(f_val, 2) - 2*num*f_val*df_z_val)/pow(f_val, 4);
    return term1 + term2 + term3;
}
...
double ddg_rr_r_r(double r, double z, Params *p) {
    ...
    double dnum_r = 2*(2*e_2gamma*pow(dgamma_r_val, 2)*f_val + e_2gamma*ddgamma_r_r(r, z, p)*f_val + e_2gamma*dgamma_r_val*df_r_val) - (2*e_2gamma*dgamma_r_val*df_r_val + e_2gamma*ddf_r_r(r, z, p));
    return (dnum_r*pow(f_val, 2) - 2*num*f_val*df_r_val)/pow(f_val, 4);
}
double ddg_rr_r_z(double r, double z, Params *p) {
    ...
    double num = 2*e_2gamma*dgamma_r_val*f_val - e_2gamma*df_r_val;
    double dnum_z = 2*(2*e_2gamma*dgamma_r_val*dgamma_z_val*f_val + e_2gamma*ddgamma_r_z(r, z, p)*f_val + e_2gamma*dgamma_r_val*df_z_val) - (2*e_2gamma*dgamma_z_val*df_r_val + e_2gamma*ddf_r_z(r, z, p));
    return (dnum_z*pow(f_val, 2) - 2*num*f_val*df_z_val)/pow(f_val, 4);
}
double ddg_rr_z_z(double r, double z, Params *p) {
    ...
    double dnum_z = 2*(2*e_2gamma*pow(dgamma_z_val, 2)*f_val + e_2gamma*ddgamma_z_z(r, z, p)*f_val + e_2gamma*dgamma_z_val*df_z_val) - (2*e_2gamma*dgamma_z_val*df_z_val + e_2gamma*ddf_z_z(r, z, p));
    return (dnum_z*pow(f_val, 2) - 2*num*f_val*df_z_val)/pow(f_val, 4);
}
...
double Det_r(double r, double z, Params *p) {
    return g_tt(r, z, p)*dg_ff_r(r, z, p) + dg_tt_r(r, z, p)*g_ff(r, z, p) - 2*g_tf(r, z, p)*dg_tf_r(r, z, p);
}
double Det_z(double r, double z, Params *p) {
    return g_tt(r, z, p)*dg_ff_z(r, z, p) + dg_tt_z(r, z, p)*g_ff(r, z, p) - 2*g_tf(r, z, p)*dg_tf_z(r, z, p);
}
...
double line_element(double dt, double dphi, double r, double z, Params *p) {
    double term1 = -f(r, z, p)*pow(dt - omega(r, z, p)*dphi, 2);
    double term2 = (exp(2*my_gamma(r, z, p))*(r*r + z*z) + r*r*dphi)/f(r, z, p);
    return sqrt(fabs(term1 + term2));
}
...
int main() {
    ...
    double z = 3.0;
    double h = 1e-5;
    double numerical_derivation[4][4][4][4] = {0};
    double dg_1[4][4][4] = {0};
    double dg_2[4][4][4] = {0};
    
    double symbolic_derivation[4][4][4][4] = {0};
